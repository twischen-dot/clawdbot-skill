...
- **目标代理**：Natuo（通过 `--agent natuo` 指定）

## 基本命令格式

```bash
clawdbot agent --agent natuo --message "<消息内容>"
```
...
3. **构建命令**：`clawdbot agent --agent natuo --message "..."`
4. **执行命令**：运行命令
